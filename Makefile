...
#    Updated: 2017/11/13 21:50:56 by dideryck         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC = ./ft_strlen.c 	ft_putchar.c 	ft_strstr.c 	ft_atoi.c 	ft_strncmp.c 	ft_putnbr.c 	ft_strcmp.c\
		ft_memcpy.c		ft_memccpy.c 	ft_memset.c 	ft_strcat.c 	ft_isdigit.c 	ft_isalpha.c 	ft_isalnum.c	-I .
...
$(NAME):
	...
	ft_memset.o		ft_strcat.o		ft_isdigit.o		ft_isalpha.o	ft_isalnum.o
