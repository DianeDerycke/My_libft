...
#    Updated: 2017/11/16 18:02:03 by dideryck         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC = ./ft_strlen.c 	ft_putchar.c 	ft_strstr.c 	ft_atoi.c 	ft_strncmp.c 	ft_putnbr.c 	ft_strcmp.c\
		...
		ft_strcpy.c 	ft_strncpy.c 	ft_memalloc.c 	ft_memdel.c 	ft_strnew.c		ft_strdel.c 	-I .
...
$(NAME):
	...
	ft_bzero.o		ft_strdup.o		ft_strcpy.o		ft_strncpy.o	ft_memalloc.o	ft_memdel.o		ft_strnew.o		ft_strdel.o
clean: 
