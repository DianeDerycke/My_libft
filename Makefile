...
#    Updated: 2017/11/17 21:35:56 by dideryck         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC = ./ft_strlen.c 	ft_putchar.c 	ft_strstr.c 	ft_atoi.c 	ft_strncmp.c 	ft_putnbr.c 	ft_strcmp.c\
		...
		ft_strmap.c 	ft_strequ.c 	ft_strsub.c 	ft_strjoin.c 	ft_strtrim.c 	ft_putstr.c -I .
...
$(NAME):
	...
	ft_strmap.o		ft_strequ.o		ft_strsub.o		ft_strjoin.o	ft_strtrim.o	ft_putstr.o
clean: 
